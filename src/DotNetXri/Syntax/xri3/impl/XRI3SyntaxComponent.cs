...
public abstract class XRI3SyntaxComponent : XRISyntaxComponent {
	...
	public int compareTo(Object obj) {
		...
		if (obj is String) return(this.toString().compareTo((String) obj));
		if (! (obj is XRI3SyntaxComponent)) return(0);
	...
	public bool equals(Object obj) {
		...
		if (obj is String) return(this.toString().equals(obj));
		if (! (obj is XRI3SyntaxComponent)) return(false);
